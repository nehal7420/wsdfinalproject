...
//https://web.njit.edu/~kwilliam/mvc/index.php?page=accounts&action=all
        ...
        $routes[] = routeProcedure::create('GET', 'show', 'homepage', 'homepageController', 'show');
        $routes[] = routeProcedure::create('POST', 'create', 'homepage', 'homepageController', 'create');
        $routes[] = routeProcedure::create('GET', 'all', 'tasks', 'tasksController', 'all');
        $routes[] = routeProcedure::create('GET', 'all', 'accounts', 'accountsController', 'all');
        $routes[] = routeProcedure::create('GET', 'show', 'accounts', 'accountsController', 'show');
        $routes[] = routeProcedure::create('GET', 'show', 'tasks', 'tasksController', 'show');
        $routes[] = routeProcedure::create('POST', 'login', 'accounts', 'accountsController', 'login');
        $routes[] = routeProcedure::create('POST', 'delete', 'tasks', 'tasksController', 'delete');
        $routes[] = routeProcedure::create('POST', 'delete', 'accounts', 'accountsController','delete');
        $routes[] = routeProcedure::create('GET', 'edit', 'accounts', 'accountsController', 'edit');
        $routes[] = routeProcedure::create('POST', 'save', 'accounts', 'accountsController', 'save');
        $routes[] = routeProcedure::create('POST', 'save', 'tasks', 'tasksController', 'save');
        $routes[] = routeProcedure::create('POST', 'insert', 'tasks', 'tasksController', 'insert');
